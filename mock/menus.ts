...
router.get('/', (req, res) => {
  ...
  res.send([
    ...
    req.can(Role.staff) && {
      id: '610159148224d543ae4e05d01',
      label: 'Drag',
      icon: 'drag',
      // name: 'media',
      children: [
        { id: '610159148224d543ae4e05d11', label: 'card-drag', name: 'card-drag' },
        { id: '610159148224d543ae4e05d21', label: 'icon-drag', name: 'icon-drag' }
      ].filter(Boolean)
    },
    req.can(Role.admin) && {
    ...
    req.can(Role.staff) && {
      id: '610159148224d543ae4e05e6',
      label: 'Map',
      icon: 'navigate',
      // name: 'options',
      // params: { type: 'general' },
      children: [
        { id: '610159148224d543ae4e05e51', label: 'BaiduMap', name: 'BaiduMap', params: { type: 'general' } },
        { id: '610159148224d543ae4e05e71', label: 'TencentMap', name: 'TencentMap', params: { type: 'general' } },
        { id: '610159148224d543ae4e05e72', label: 'MapBox', name: 'MapBox', params: { type: 'general' } },
        // { id: '610159148224d543ae4e05e6', label: 'TencentMap', name: 'TencentMap', params: { type: 'writing' } },
        // { id: '610159148224d543ae4e05e7', label: 'Reading', name: 'options', params: { type: 'reading' } },
        // { id: '610159148224d543ae4e05e8', label: 'Discussion', name: 'options', params: { type: 'discussion' } },
        // { id: '610159148224d543ae4e05e9', label: 'Media', name: 'options', params: { type: 'media' } },
        // req.can(Role.admin) && { id: '610159148224d543ae4e05ea', label: 'Permalink', name: 'options', params: { type: 'permalink' } }
