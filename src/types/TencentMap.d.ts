...
declare namespace TMap {
    ...
    class Map {
         ...
         * @returns {Map}
         */
        constructor(container: (string | HTMLElement), opts?: TencentMapOptions);
         ...
         * var map = new TMap.Map(“container”, {mapType: BMAP_PERSPECTIVE_MAP}); map.setCurrentCity(“北京市”); map.centerAndZoom(new TMap.Point(116.404, 39.915), 18); 注意：初始化的坐标应与您设置的城市对应，否则地图将无法正常显示。如果地图初始化为BMAP_NORMAL_MAP类型，则在调用setMapType切换地图类型时也要调用此方法。(自 1.1 新增)
         * @param city
         * @returns {}
         */
...
declare module TMapLib {
    ...
    class MarkerClusterer {
         ...
         * @returns {}
         */
        constructor(map: TMap.Map, options?: TMapLibOptions.MarkerClustererOptions);
         ...
         * @returns {}
         */
        addMarker(marker: TMap.Marker): void;
         ...
         * @returns {}
         */
        addMarkers(markers: Array<TMap.Marker>): void;
        ...
        /**
         * 获取所有的标记数组。
         * @returns {Array<TMap.Marker>} 标记数组。
         */
        getMarkers(): Array<TMap.Marker>;
         ...
         * @returns {} 聚合的样式风格集合
         */
        getStyles(): Array<TMapLibOptions.IconStyle>;
         ...
         */
        removeMarker(marker: TMap.Marker): boolean;
         ...
         * @returns {} 删除成功返回true，否则返回false
         */
        removeMarkers(markers: Array<TMap.Marker>): boolean;
         ...
         * @returns {}
         */
        setStyles(styles: Array<TMapLibOptions.IconStyle>): void;
    }
    ...
    class TextIconOverlay {
        constructor(position: TMap.Point, text: string, options: TMapLibOptions.TextIconOverlayOptions);
         ...
         * @returns {} 对应的索引值。
         */
        getStyleByText(text: string, styles: Array<TMapLibOptions.IconStyle>): number;
         ...
         * @param map TMap.Map的实例化对象。
         * @returns {} 返回覆盖物对应的HTML元素。
         */
        initialize(map: TMap.Map): HTMLElement;
         ...
         * @returns {}
         */
        setPosition(position: TMap.Point): void;
